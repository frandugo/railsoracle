...
class TelefonosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create telefono" do
    assert_difference('Telefono.count') do
      post telefonos_url, params: { telefono: { iddoce: @telefono.iddoce, idnom: @telefono.idnom, telefono: @telefono.telefono } }
    end
  ...
  test "should update telefono" do
    patch telefono_url(@telefono), params: { telefono: { iddoce: @telefono.iddoce, idnom: @telefono.idnom, telefono: @telefono.telefono } }
