...
class EstudiantesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create estudiante" do
    assert_difference('Estudiante.count') do
      post estudiantes_url, params: { estudiante: { ape1: @estudiante.ape1, ape2: @estudiante.ape2, idac: @estudiante.idac, idcu: @estudiante.idcu, iddoc: @estudiante.iddoc, nom1: @estudiante.nom1, nom2: @estudiante.nom2 } }
    end
  ...
  test "should update estudiante" do
    patch estudiante_url(@estudiante), params: { estudiante: { ape1: @estudiante.ape1, ape2: @estudiante.ape2, idac: @estudiante.idac, idcu: @estudiante.idcu, iddoc: @estudiante.iddoc, nom1: @estudiante.nom1, nom2: @estudiante.nom2 } }
