...
class PeriodosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create periodo" do
    assert_difference('Periodo.count') do
      post periodos_url, params: { periodo: { fechaf: @periodo.fechaf, fechai: @periodo.fechai, periodo: @periodo.periodo } }
    end
  ...
  test "should update periodo" do
    patch periodo_url(@periodo), params: { periodo: { fechaf: @periodo.fechaf, fechai: @periodo.fechai, periodo: @periodo.periodo } }
