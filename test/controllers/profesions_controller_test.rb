...
class ProfesionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create profesion" do
    assert_difference('Profesion.count') do
      post profesions_url, params: { profesion: { iddoce: @profesion.iddoce, nompro: @profesion.nompro, tarpro: @profesion.tarpro } }
    end
  ...
  test "should update profesion" do
    patch profesion_url(@profesion), params: { profesion: { iddoce: @profesion.iddoce, nompro: @profesion.nompro, tarpro: @profesion.tarpro } }
