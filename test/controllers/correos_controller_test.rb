...
class CorreosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create correo" do
    assert_difference('Correo.count') do
      post correos_url, params: { correo: { correo: @correo.correo, iddoce: @correo.iddoce, idnom: @correo.idnom } }
    end
  ...
  test "should update correo" do
    patch correo_url(@correo), params: { correo: { correo: @correo.correo, iddoce: @correo.iddoce, idnom: @correo.idnom } }
