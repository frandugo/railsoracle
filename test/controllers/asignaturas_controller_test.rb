...
class AsignaturasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create asignatura" do
    assert_difference('Asignatura.count') do
      post asignaturas_url, params: { asignatura: { idtpasi: @asignatura.idtpasi, nomasi: @asignatura.nomasi, numasi: @asignatura.numasi } }
    end
  ...
  test "should update asignatura" do
    patch asignatura_url(@asignatura), params: { asignatura: { idtpasi: @asignatura.idtpasi, nomasi: @asignatura.nomasi, numasi: @asignatura.numasi } }
