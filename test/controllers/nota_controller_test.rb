...
class NotaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create notum" do
    assert_difference('Notum.count') do
      post nota_url, params: { notum: { nota1: @notum.nota1, nota2: @notum.nota2, nota3: @notum.nota3 } }
    end
  ...
  test "should update notum" do
    patch notum_url(@notum), params: { notum: { nota1: @notum.nota1, nota2: @notum.nota2, nota3: @notum.nota3 } }
