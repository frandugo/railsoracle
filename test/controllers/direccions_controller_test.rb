...
class DireccionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create direccion" do
    assert_difference('Direccion.count') do
      post direccions_url, params: { direccion: { direccion: @direccion.direccion, idmun: @direccion.idmun, idnom: @direccion.idnom } }
    end
  ...
  test "should update direccion" do
    patch direccion_url(@direccion), params: { direccion: { direccion: @direccion.direccion, idmun: @direccion.idmun, idnom: @direccion.idnom } }
