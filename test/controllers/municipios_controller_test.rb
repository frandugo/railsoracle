...
class MunicipiosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create municipio" do
    assert_difference('Municipio.count') do
      post municipios_url, params: { municipio: { iddep: @municipio.iddep, nommun: @municipio.nommun } }
    end
  ...
  test "should update municipio" do
    patch municipio_url(@municipio), params: { municipio: { iddep: @municipio.iddep, nommun: @municipio.nommun } }
