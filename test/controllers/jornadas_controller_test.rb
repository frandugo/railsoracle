...
class JornadasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create jornada" do
    assert_difference('Jornada.count') do
      post jornadas_url, params: { jornada: { idgru: @jornada.idgru, jornada: @jornada.jornada } }
    end
  ...
  test "should update jornada" do
    patch jornada_url(@jornada), params: { jornada: { idgru: @jornada.idgru, jornada: @jornada.jornada } }
